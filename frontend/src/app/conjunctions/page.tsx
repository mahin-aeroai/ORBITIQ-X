...
export const metadata: Metadata = { title: "Conjunctions | ORBITIQ-X" };
export default function ConjunctionsPage() {
  return (
    <div style={{display:"flex",height:"100%",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:16,padding:32}}>
      ...
      <div style={{fontFamily:"var(--font-display)",fontSize:28,fontWeight:700,color:"var(--color-text-primary)"}}>Conjunction Analysis</div>
      <div style={{fontFamily:"var(--font-mono)",fontSize:11,color:"rgba(148,163,184,0.5)",maxWidth:440,textAlign:"center",lineHeight:1.8}}>CDM screening, probability of collision, maneuver recommendations. Requires populated satellite catalog.</div>
