...
export const metadata: Metadata = { title: "Agents | ORBITIQ-X" };
export default function AgentsPage() {
  return (
    <div style={{display:"flex",height:"100%",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:16,padding:32}}>
      ...
      <div style={{fontFamily:"var(--font-display)",fontSize:28,fontWeight:700,color:"var(--color-text-primary)"}}>AI Agent System</div>
      <div style={{fontFamily:"var(--font-mono)",fontSize:11,color:"rgba(148,163,184,0.5)",maxWidth:440,textAlign:"center",lineHeight:1.8}}>LangGraph multi-agent reasoning — conjunction analysis, maneuver planning, anomaly detection. Powered by Claude.</div>
