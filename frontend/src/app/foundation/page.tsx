...
export const metadata: Metadata = { title: "Foundation | ORBITIQ-X" };
export default function FoundationPage() {
  return (
    <div style={{display:"flex",height:"100%",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:16,padding:32}}>
      ...
      <div style={{fontFamily:"var(--font-display)",fontSize:28,fontWeight:700,color:"var(--color-text-primary)"}}>Foundation Models</div>
      <div style={{fontFamily:"var(--font-mono)",fontSize:11,color:"rgba(148,163,184,0.5)",maxWidth:440,textAlign:"center",lineHeight:1.8}}>Aerospace foundation model benchmarks, RAG pipeline management, LoRA fine-tuning control. Admin access only.</div>
